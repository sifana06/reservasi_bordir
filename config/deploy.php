...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@gitlab.com:dydan-project/reservasi-bordir.git',
        'php_fpm_service' => 'php7.5-fpm',
    ],
    ...
    */
    ...
    'hosts' => [
        'reservasi-borline.000webhostapp.com' => [
            'deploy_path' => '/media/websites/reservasi-borline.000webhostapp.com',
            'user' => 'root',
        ],
    ],
